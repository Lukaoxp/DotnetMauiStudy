...
namespace MauiSQLite.Services
{
    public class AgendaService : IAgendaService
    {
        ...
        private async Task SetUpDb()
        {
            ...
            var databasePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "agenda.db3");
        ...
        {
            return await _dbConnection.GetAsync<Contato>(id);
        }
